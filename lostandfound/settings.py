...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-campus-lf-dev-key-change-in-production'
)

DEBUG = os.environ.get('DEBUG', 'True').lower() == 'true'


ALLOWED_HOSTS = ['*'] if os.environ.get('VERCEL') else [h for h in os.environ.get('ALLOWED_HOSTS', '*').split(',') if h]
...
# Database — uses DATABASE_URL env var in prod, SQLite locally
DATABASES = {
...
DEFAULT_FROM_EMAIL = 'Campus Lost & Found <noreply@campuslf.com>'
